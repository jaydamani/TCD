...
module.exports =  new baseEvent('message',async (message) => {
    ...
    console.log(filter.isProfane(message.content))
    if(filter.isProfane(message.content)){

	modLog = client.channels.resolve(modLog)
	message.delete()
	let warnMessage = await message.channel.send(`${message.author}, please don't swear much. There are kids here like me :pleading_face:`)
